# Frontend - Introdução ao Desenvolvimento de Sistemas Web

Este é o repositório do frontend do projeto, construído em Next.js (TypeScript, Tailwind CSS).
...
*   `web/`: Contém a aplicação Next.js.
*   `comandos_uteis.txt`: Comandos úteis para o desenvolvimento do frontend.
